...
def decode_account_jwt(request : Request):
    ...
    try:
        for permission in Config['REQUIRED_PERMISSIONS']:
            if permission not in decoded_token['b']['pe']:
                raise OctyException(401,'Insufficient resource permissions', [{'error_message' : f'This account is not permitted to access this resource. If you wish to access this resource, please contact our support team. {Config["SUPPORT_EMAIL"]}', 
