...
def assess_resource_limit(limits : str, current_count : int, requested : int, resource_key : int) -> Union[bool, dict]:
    """
        ...
        resource_key : int
            change index to obtain required limit
        ...
        counts : dict
    """
    resource_limit = int(limits.split('*')[resource_key]) # change index to obtain required limit
