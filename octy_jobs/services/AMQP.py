# module imports
from data.models.octy_jobs import *
        ...
        async with message_payload.process(ignore_processed=True):
            ...
            try:
                ...
                if routing_key == 'octy.job.cmd.create':
                    ...
                    await OctyJobQueueService(delete_jobs.account_id)\
