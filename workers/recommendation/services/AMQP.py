...
from config import *
from data.models.rec_jobs import *
    ...
    async def message_handler_callback(self, message_payload : object):
        ...
        async with message_payload.process(ignore_processed=True):
            ...
            if routing_key == 'rec.training.cmd.run':
                ...
                await RecommenderTraining(account_id=job_data.account_data.account_id, 
                ...
                await RecommenderCompleteTrainingJob(account_id=job_data.account_data.account_id,
                                                    algorithm_configurations=job_data.rec_job_data.algorithm_configurations,
                                                    octy_job_id=job_data.octy_job_id,
                                                    training_job_id=job_data.rec_job_data.training_job_id,
                                                    bucket=job_data.rec_job_data.bucket,
