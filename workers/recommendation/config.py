...
try:
    Config = json.loads(base64_decode(os.environ.get('RECOMMENDATION_WORKER_CONFIG')))
except TypeError:
    Config = base64_decode(os.environ.get('RECOMMENDATION_WORKER_CONFIG'))

# Config = {
#     "ENV" : "recommendation.worker.development",
#     "SENTRY_URL" : "https://e4b80290888a4267a2224efc6dbed258@o324132.ingest.sentry.io/1826169",
#     "DB_ALIAS" : "recommendations_db",
...
#     "MIN_NUM_EVENTS_COLLECTIVE" : 400,
#     "MIN_NUM_ITEMS" : 10,
#     "SYSTEM_REC_EVENT_TYPE" : "charged",
...
#     "REC_DATA_DIR" : "resources/training_job_data/recommendations_data",
...
#     "MAX_NUM_PARTS" : 10000,
#     "REC_MODELS_DIR" : "models/recommendation_models",
#     "RECOMMENDATION_ALGORITHM_DOCKER_PATH" : "456239226913.dkr.ecr.eu-west-2.amazonaws.com/octy/recommendations:latest",
#     "RECOMMENDATION_SM_INPUT_MODE" : "File",
#     "REC_TRAINING_HYPERPARAMETERS" : {"no_components": "150", "learning_rate" : "0.05", "loss" :"warp", "random_state": "2019", "epochs": "120", "num_threads": "4"},
