...
from config import *
from data.models.rfm_jobs import *
    ...
    async def message_handler_callback(self, message_payload : object):
        ...
        async with message_payload.process(ignore_processed=True):
            ...
            if routing_key == 'rfm.training.cmd.run':
                ...
                await RFMAnalysis(account_id=job_data.account_data.account_id, 
                ...
                await RFMCompleteAnalysis(account_id=job_data.account_data.account_id,
                                        octy_job_id=job_data.octy_job_id,
