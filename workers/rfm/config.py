...
try:
    Config = json.loads(base64_decode(os.environ.get('RFM_WORKER_CONFIG')))
except TypeError:
    Config = base64_decode(os.environ.get('RFM_WORKER_CONFIG'))

# Config = {
#     "ENV" : "rfm.worker.development",
#     "SENTRY_URL" : "https://e4b80290888a4267a2224efc6dbed258@o324132.ingest.sentry.io/1826169",
#     "DB_ALIAS" : "rfm_analysis_db",
...
#     "RFM_DATA_DIR" : "resources/training_job_data/rfm_data",
...
#     "MAX_NUM_PARTS" : 10000,
#     "RFM_MODELS_DIR" : "models/rfm_dataframes",
#     "RFM_ALGORITHM_DOCKER_PATH" : "391735608603.dkr.ecr.eu-west-2.amazonaws.com/octy/rfm_analysis:latest",
#     "RFM_SM_INPUT_MODE" : "File",
#     "AWS_REGION" : "eu-west-2",
#     "AWS_SERVER_SIDE_ENCRYPTION" : "AES256",
#     "AWS_ROLE_ARN" : "arn:aws:iam::391735608603:role/AmazonSageMaker",
